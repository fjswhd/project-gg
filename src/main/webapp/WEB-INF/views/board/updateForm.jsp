...
<body>
	<div class="container flex-column" style="overflow: hidden">
		...
		<div class="col-md-9 mg-auto box flex" style="height: 75%; top: 20%;">
			<form action="${_board}/update.do" method="post" name="frm" class="flex-column f-1">
				<!-- 조회수, 작성자(세션의 유저)  -->
				...
				<div class="align-center f-s mg-b-5">
					...
					<span class="col-md-10 pd-0">
						<span class="input-group input-group-sm">
							...
							<span id="searchResult" class="mg-r-5">${board.address}</span>
				...
				<div class="align-center f-s mg-b-5">
					...
					<span class="col-md-10 pd-0">
						<input type="text" name="subject" class="form-control input-sm" placeholder="제목" required="required" value="${board.subject}" maxlength="60">					
					</span>
				</div>
