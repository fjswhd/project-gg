...
<body>
	<div class="flex f-1" style="height: 100%;">
		...
		<div style="width: 35%; padding: 15px; overflow: hidden;">
			<!-- 검색창 -->
			<div>
	...
	<script type="text/javascript">
		...
		function getListItem(index, places) {
		    ...
		    itemStr = '<td>' +
						'<div class="info">' +
						'<h4 class="text-primary">' + places.place_name + '</h4>';
		    if (places.road_address_name) {
		        itemStr += '<h5>'+ places.address_name +' <small>'+ places.road_address_name +'</small></h5>';
		    } else {
