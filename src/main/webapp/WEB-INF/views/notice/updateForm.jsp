...
<body>
	<div class="container flex-column" style="overflow: hidden">
		...
		<div class="col-md-9 mg-auto box flex" style="height: 75%; top: 20%;">
			<form action="${_notice}/update.do" method="post" name="frm" class="flex-column f-1">
				<!-- 조회수, 작성자(세션의 유저)  -->
				<input type="hidden" name="readcount" value="${notice.readcount}">
				...
				<div class="align-center f-s mg-b-5">
					<input type="text" name="subject" class="form-control input-sm" placeholder="제목" required="required" value="${notice.subject}">					
				</div>
				...
				<div class="align-center f-s j-end">
					<button id="submit" type="submit" class="btn btn-primary mg-r-5">수정하기</button>
					<a href="${_notice}/detail.do?no_no=${notice.no_no}" class="btn btn-danger">취소</a>
				</div>
			</form>
		</div>
